...
if(isset($_POST['create'])){
    ...
    $status = $_POST['status'];
    $megatitle = $_POST['megatitle'];
    $megades = $_POST['megades'];

    $insert = "INSERT INTO `add_category` ( `image`, `c_name`, `slug`, `date`, `description`, `status`, `mega-title`, `meda_des`) VALUES ('$image', '$cname', '$slug', '$date', '$des', '$status', '$megatitle', '$megades')";
                                                                 ...
                                                                 <div class="row">
                                                                     ...
                                                                     <div class="mb-3 col-lg-12 mt-5 ">
                                                                         ...
                                                                         <div class="mb-3">
                                                                             ...
                                                                             <input type="text" class="form-control" placeholder="Title" name = "megatitle">
                                                                         </div>
                                                                         ...
                                                                         <div class="mb-3">
                                                                             ...
                                                                             <textarea class="form-control" rows="3"
                                                                                 placeholder="Meta Description" name = "description"></textarea>
                                                                         </div>
                                                                     </div>
                                                                     <div class="col-lg-12">
